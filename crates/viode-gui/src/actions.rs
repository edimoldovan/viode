...
impl Action {
    ...
    pub fn label(self) -> &'static str {
        match self {
            ...
            Action::AddMarker => "Add marker at playhead",
            Action::Freeze => "Freeze frame at playhead",
            Action::Mend => "Mend cut with a morph",
            Action::MatchPrevious => "Match look to previous clip",
            Action::BundleAdd => "Bundle a project as a clip…",
            Action::Captions => "Generate captions",
            Action::Duck => "Duck music under dialogue",
            Action::Undo => "Undo",
            Action::Redo => "Redo",
            Action::Save => "Save project",
            Action::RenderDialog => "Render…",
            Action::Watch => "Watch the latest render",
            Action::ToggleScopes => "Toggle scopes",
            Action::EngineCheckup => "Engine checkup",
            Action::ConnectAi => "Connect your AI",
    ...
    pub fn keywords(self) -> &'static str {
        match self {
            ...
            Action::AddMarker => "note chapter todo flag point",
            Action::Freeze => "frame hold still pause",
            Action::Mend => "morph jump cut smooth interview",
            Action::MatchPrevious => "shot color exposure grade",
            Action::BundleAdd => "nested sequence project import",
            Action::Captions => "subtitles srt transcript burn lower third",
            Action::Duck => "music sidechain lower volume speech auto",
            ...
            Action::Watch => "player review result video open mpv chapters",
            Action::ToggleScopes => "waveform vectorscope color measure",
            Action::EngineCheckup => "doctor missing plugins gstreamer diagnose",
            Action::ConnectAi => "claude cursor opencode assistant mcp setup",
